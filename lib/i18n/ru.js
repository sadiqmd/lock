...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests:
        'Вы достигли предельного числа запросов на восстановление пароля. Пожалуйста, подождите перед повторной попыткой.',
      'lock.fallback':
        'Произошла непредвиденная ошибка при запросе на восстановление пароля. Приносим свои извинения.'
    },
    login: {
      blocked_user: 'Пользователь заблокирован.',
      invalid_user_password: 'Неверный пароль.',
      'lock.fallback':
        'Произошла непредвиденная ошибка при попытке авторизации. Приносим свои извинения.',
      ...
      password_change_required:
        'Необходимо обновить пароль, посколько Вы совершаете вход в первый раз, или срок действия пароля истек.',
      password_leaked:
        'Эта учетная запись была заблокирована, поскольку произошла утечка Вашего пароля на другом веб-сайте. На Ваш электронный адрес отправлена инструкция по восстановлению учетной записи.',
      too_many_attempts:
        'Ваш аккаунт был заблокирован после нескольких последовательных попыток входа в систему.',
      'lock.mfa_registration_required':
        'Многофакторная аутентификация требуется, но устройство не зарегистрирован. Пожалуйста, зарегистрировать его, прежде чем двигаться дальше.',
    ...
    signUp: {
      ...
      'lock.fallback':
        'Произошла непредвиденная ошибка при попытке создания учетной записи. Приносим свои извинения.',
  ...
  enterpriseLoginIntructions:
    'Используйте учетные данные Вашей корпоративной учетной записи для входа.',
  ...
  passwordlessEmailAlternativeInstructions:
    'Либо введите адрес электронной почты, чтобы войти<br>или зарегистрироваться',
