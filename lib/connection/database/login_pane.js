...
var LoginPane = (function(_React$Component) {
  ...
  LoginPane.prototype.handleDontRememberPasswordClick = function handleDontRememberPasswordClick(
    e
  ) {
    e.preventDefault();
  ...
  LoginPane.prototype.render = function render() {
    ...
    var dontRememberPassword =
      showForgotPasswordLink && (0, _index.hasScreen)(lock, 'forgotPassword')
        ? _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              {
                ...
                onClick: (0, _index.forgotPasswordLink)(lock)
                  ? undefined
                  : this.handleDontRememberPasswordClick.bind(this)
              },
