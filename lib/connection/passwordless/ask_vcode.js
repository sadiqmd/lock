...
var Component = function Component(_ref) {
  ...
  var instructions = (0, _index.isEmail)(model)
    ? i18n.html('passwordlessEmailCodeInstructions', (0, _index2.getFieldValue)(model, 'email'))
    : i18n.html(
        'passwordlessSMSCodeInstructions',
        (0, _phone_number.humanPhoneNumberWithDiallingCode)(model)
      );
