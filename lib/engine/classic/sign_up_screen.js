...
var Component = function Component(_ref) {
  ...
  return _react2.default.createElement('div', null, ssoNotice, tabs, social, separator, db);
};
...
var SignUp = (function(_Screen) {
  ...
  SignUp.prototype.renderAuxiliaryPane = function renderAuxiliaryPane(lock) {
    return (
      ...
      (0, _signed_up_confirmation.renderSignedUpConfirmation)(lock) ||
      (0, _index2.renderOptionSelection)(lock)
    );
  };
  ...
  SignUp.prototype.renderTerms = function renderTerms(m, terms) {
    var checkHandler = (0, _index.mustAcceptTerms)(m)
      ? function() {
          return (0, _actions.toggleTermsAcceptance)(l.id(m));
        }
      : undefined;
    return terms || (0, _index.mustAcceptTerms)(m)
