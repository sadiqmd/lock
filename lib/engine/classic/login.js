...
var _actions3 = require('../../quick-auth/actions');
...
var Component = function Component(_ref) {
  ...
  if (l.hasSomeConnections(model, 'enterprise')) {
    var connection = l.connections(model, 'enterprise').get(0);
    ...
    enterprise =
      ...
      _react2.default.createElement(_quick_auth_pane2.default, {
        ...
        buttonClickHandler: function buttonClickHandler(e) {
          return (0, _actions3.logIn)(l.id(model), connection);
        },
        header: header,
  ...
  var separator =
    (enterprise || social) &&
    login &&
    _react2.default.createElement(_pane_separator2.default, null);
