...
function hasOnlyClassicConnections(m) {
  ...
  return (
    l.hasOnlyConnections.apply(l, [m, type].concat(strategies)) &&
...
function validateAllowedConnections(m) {
  ...
  if (!anyDBConnection && !anySocialConnection && !anyEnterpriseConnection) {
    ...
    !anyDBConnection &&
    !anySocialConnection &&
    (0, _index4.hasInitialScreen)(m, 'signUp')
  ) {
  ...
  if ((0, _tenant.defaultDirectoryName)(m) && !(0, _tenant.defaultDirectory)(m)) {
    l.error(
      ...
      'The account\'s default directory "' +
        (0, _tenant.defaultDirectoryName)(m) +
        '" is not enabled.'
    );
  }
  ...
  if ((0, _index4.defaultDatabaseConnectionName)(m) && !(0, _index4.defaultDatabaseConnection)(m)) {
    l.warn(
      ...
      'The provided default database connection "' +
        (0, _index4.defaultDatabaseConnectionName)(m) +
        '" is not enabled.'
    );
  }

  if (
    (0, _enterprise.defaultEnterpriseConnectionName)(m) &&
    !(0, _enterprise.defaultEnterpriseConnection)(m)
  ) {
    l.warn(
      m,
...
var Classic = (function() {
  ...
  Classic.prototype.render = function render(m) {
    ...
    if (
      !(0, _index4.hasScreen)(m, 'login') &&
      !(0, _index4.hasScreen)(m, 'signUp') &&
      !(0, _index4.hasScreen)(m, 'forgotPassword')
    ) {
      var errorMessage =
