...
var _social_or_phone_number_login_screen2 = _interopRequireDefault(
  _social_or_phone_number_login_screen
);
...
var _index5 = require('../core/sso/index');

var sso = _interopRequireWildcard(_index5);
...
var Passwordless = (function() {
  ...
  Passwordless.prototype.render = function render(m) {
    ...
    if ((0, _index2.isEmail)(m)) {
      return (0, _index2.isSendLink)(m) || !(0, _index2.passwordlessStarted)(m)
        ? new _social_or_email_login_screen2.default()
        : new _ask_vcode2.default();
    } else {
      return (0, _index2.passwordlessStarted)(m)
        ? new _ask_vcode2.default()
        : new _social_or_phone_number_login_screen2.default();
    }
