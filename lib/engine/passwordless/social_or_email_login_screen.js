...
var Component = function Component(_ref) {
  ...
  var social = l.hasSomeConnections(model, 'social')
  ...
  var email = l.hasSomeConnections(model, 'passwordless', 'email')
  ...
  var emailInstructionsI18nKey = social
    ? 'passwordlessEmailAlternativeInstructions'
    : 'passwordlessEmailInstructions';

  var headerText = i18n.html(emailInstructionsI18nKey) || null;
  var header = email && headerText && _react2.default.createElement('p', null, headerText);

  var separator =
    social && email ? _react2.default.createElement(_pane_separator2.default, null) : null;

  return _react2.default.createElement('div', null, social, separator, header, email);
};
...
var SocialOrEmailLoginScreen = (function(_Screen) {
  ...
  SocialOrEmailLoginScreen.prototype.submitHandler = function submitHandler(m) {
    return l.hasSomeConnections(m, 'passwordless', 'email')
      ? _actions.requestPasswordlessEmail
      : null;
  };

  SocialOrEmailLoginScreen.prototype.renderAuxiliaryPane = function renderAuxiliaryPane(lock) {
    return (
      (0, _email_sent_confirmation.renderEmailSentConfirmation)(lock) ||
      (0, _signed_in_confirmation.renderSignedInConfirmation)(lock)
    );
  };
