...
var Component = function Component(_ref) {
  ...
  var phoneNumberInstructionsI18nKey = social
    ? 'passwordlessSMSAlternativeInstructions'
    : 'passwordlessSMSInstructions';

  var phoneNumber = l.hasSomeConnections(model, 'passwordless', 'sms')
  ...
  var separator =
    social && phoneNumber ? _react2.default.createElement(_pane_separator2.default, null) : null;

  return _react2.default.createElement('div', null, social, separator, phoneNumber);
};
...
var AskSocialNetworkOrPhoneNumber = (function(_Screen) {
  ...
  AskSocialNetworkOrPhoneNumber.prototype.renderAuxiliaryPane = function renderAuxiliaryPane(lock) {
    return (
      ...
      (0, _index3.renderOptionSelection)(lock)
    );
  };
