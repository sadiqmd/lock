...
function validateUsername(str, validateFormat) {
  var settings =
    arguments.length > 2 && arguments[2] !== undefined
      ? arguments[2]
      : DEFAULT_CONNECTION_VALIDATION.username;
...
function setUsername(m, str) {
  var usernameStyle =
    arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'username';
  var validateUsernameFormat =
