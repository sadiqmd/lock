...
describe('SocialButtonsPane', function() {
  ...
  it('renders correctly', function() {
    ...
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(SocialButtonsPane, defaultProps)
    ).toMatchSnapshot();
  });
  it('renders big buttons when bigButtons === true', function() {
    ...
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(
        SocialButtonsPane,
        _extends({}, defaultProps, { bigButtons: true })
      )
    ).toMatchSnapshot();
  });
  it('disables social buttons when disabled === true', function() {
    ...
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(
        SocialButtonsPane,
        _extends({}, defaultProps, { disabled: true })
      )
    ).toMatchSnapshot();
  });
  it('shows loading when showLoading === true', function() {
    ...
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(
        SocialButtonsPane,
        _extends({}, defaultProps, { showLoading: true })
      )
    ).toMatchSnapshot();
  });
