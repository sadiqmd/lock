...
describe('LoginPane', function() {
  ...
  it('renders correctly', function() {
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(_login_pane2.default, defaultProps)
    ).toMatchSnapshot();
  });
  it('shows header when instructions is not empty', function() {
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(
        _login_pane2.default,
        _extends({}, defaultProps, { instructions: 'instructions' })
      )
    ).toMatchSnapshot();
  });
  it('shows email pane when user usernameStyle === email', function() {
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(
        _login_pane2.default,
        _extends({}, defaultProps, { usernameStyle: 'email' })
      )
    ).toMatchSnapshot();
  });
  it('shows username pane when user usernameStyle !== email', function() {
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(
        _login_pane2.default,
        _extends({}, defaultProps, { usernameStyle: 'any' })
      )
    ).toMatchSnapshot();
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(
        _login_pane2.default,
        _extends({}, defaultProps, { usernameStyle: 'username' })
      )
    ).toMatchSnapshot();
  });
  it('hides password pane when showPassword===false', function() {
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(
        _login_pane2.default,
        _extends({}, defaultProps, { showPassword: false })
      )
    ).toMatchSnapshot();
  });
  describe('hides password link', function() {
    it('when showForgotPasswordLink === false', function() {
      (0, _testUtils.expectComponent)(
        _react2.default.createElement(
          _login_pane2.default,
          _extends({}, defaultProps, { showForgotPasswordLink: false })
        )
      ).toMatchSnapshot();
    });
